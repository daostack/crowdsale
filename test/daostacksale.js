...
const setup = async function () {
    ...
    params = {
        ...
        startTime: latestTimeStamp + startDelay,
        duration: duration,
        endTime: latestTimeStamp + startDelay + duration,
        rate: 500,
        wallet: accounts[5],
        cap: web3.toWei(20),
        minBuy: web3.toWei(1),
...
contract('DAOstackSale', function (accounts)  {
    ...
    it("Check owner and params", async () => {
        ...
        assert.equal(await daoStackSale.startTime(), params.startTime, "startTime is not correct");
        assert.equal(await daoStackSale.endTime(), params.endTime, "endTime is not correct");
    ...
    it("Try to go over cap", async () => {
        ...
        await buy(whiteListed[1], web3.toWei(13), false);
    });
    ...
    it("Full Scenario 1, cap filled", async () => {
        ...
        // Trying to go over cap:
        await buy(whiteListed[2], web3.toWei(8), false);
